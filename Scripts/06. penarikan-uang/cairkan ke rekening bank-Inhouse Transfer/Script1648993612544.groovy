...
//get data excel
TestData input = findTestData('06. penarikan-uang/pencairan-inhouse transfer')
for (int baris = 1; baris <= input.getRowNumbers(); baris++) {
	...
	//String str_accountno = '9980100019281'
	...
	//Mobile.setText(findTestObject('Object Repository/Penarikan Uang/penarikan success/Ejumlah_penarikan'), input.getValue('nominal_pencairan', baris), 0)
