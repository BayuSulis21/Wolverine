...
//get data excel
TestData input = findTestData('06. penarikan-uang/pencairan-online transfer')
for (int baris = 1; baris <= input.getRowNumbers(); baris++) {
	...
	Mobile.comment('Click radio button online transfer')
	Mobile.tap(findTestObject('Object Repository/Penarikan Uang/penarikan success/Radio Button - OnlineRealtime Transfer'), 0)
	Mobile.takeScreenshot()
	Mobile.delay(2)
