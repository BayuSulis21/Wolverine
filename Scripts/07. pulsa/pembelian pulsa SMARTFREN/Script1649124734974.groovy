...
//get data excel
TestData input = findTestData('07. pulsa/pembelian pulsa SMARTFREN')
for (int baris = 1; baris <= input.getRowNumbers(); baris++) {
	...
	Mobile.comment('Klik Pilih Nominal Pulsa')
	String str_paketpulsa = input.getValue('nominal', baris)
	Mobile.tap(findTestObject('pulsa/Pilih List Pulsa SMARTFREN',[('pulsa'):str_paketpulsa]), 0)
	Mobile.takeScreenshot()
	Mobile.delay(2)
