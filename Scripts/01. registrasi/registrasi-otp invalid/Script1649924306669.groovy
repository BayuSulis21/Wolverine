...
Mobile.delay(2)
		...
		Mobile.comment('Input Invalid OTP')
		Mobile.pressBack()
		Mobile.setText(findTestObject('aktivasi/Eotp1'), '1', 0)
		Mobile.pressBack()
		Mobile.setText(findTestObject('aktivasi/Eotp2'), '1', 0)
		Mobile.pressBack()
		Mobile.setText(findTestObject('aktivasi/Eotp3'), '1', 0)
		Mobile.pressBack()
		Mobile.setText(findTestObject('aktivasi/Eotp4'), '1', 0)
		Mobile.pressBack()
		Mobile.setText(findTestObject('aktivasi/Eotp5'), '1', 0)
		Mobile.pressBack()
		Mobile.delay(2)
	    Mobile.setText(findTestObject('aktivasi/Eotp6'), '1', 0)
