...
if (Mobile.verifyElementAttributeValue(findTestObject('Object Repository/Registrasi/Message - Email Aktif harus diisi'),'class','android.widget.TextView', 5)) 
	{
		Mobile.comment('Wajib mengisi Email Aktif')
	}
