...
Mobile.setText(findTestObject('Registrasi/Eemail'), GlobalVariable.email_tanpa_dot, 0)
Mobile.takeScreenshot()
...
if (Mobile.verifyElementAttributeValue(findTestObject('Object Repository/Registrasi/Message - Email Tidak Valid'),'class','android.widget.TextView', 5)) 
	{
		Mobile.comment('Email Tidak Valid')
	}
