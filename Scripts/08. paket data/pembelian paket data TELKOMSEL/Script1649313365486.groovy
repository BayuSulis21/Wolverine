...
//get data excel
TestData input = findTestData('08. paket data/paket data TELKOMSEL')
for (int baris = 1; baris <= input.getRowNumbers(); baris++) {
	...
	Mobile.tap(findTestObject('pulsa/Pilih List Paket Data TELKOMSEL',[('paket_data'):str_paketdata]), 0)
	Mobile.takeScreenshot()
	Mobile.delay(2)
