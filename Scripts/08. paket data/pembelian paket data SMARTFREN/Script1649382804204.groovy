...
//get data excel
TestData input = findTestData('08. paket data/paket data SMARTFREN')
for (int baris = 1; baris <= input.getRowNumbers(); baris++) {
	...
	Mobile.tap(findTestObject('pulsa/Pilih List Paket Data SMARTFREN',[('paket_data'):str_paketdata]), 0)
	Mobile.takeScreenshot()
	Mobile.delay(2)
