...
import java.text.SimpleDateFormat
	...
	WebUI.comment("Get Amount Tagihan")
	WS.callTestCase(findTestCase('16. Retribusi - Globalindo/RE-38. BE-Inquiry Retribusi dengan location ID dan Idno Valid'), null)
