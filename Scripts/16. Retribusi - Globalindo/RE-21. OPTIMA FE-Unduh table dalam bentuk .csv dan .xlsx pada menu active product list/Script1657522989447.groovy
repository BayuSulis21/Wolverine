...
WebUI.scrollToElement(findTestObject('Object Repository/optima/optima-dashboard/button_Export'), 0)

WebUI.click(findTestObject('Object Repository/optima/optima-dashboard/button_Export'))
WebUI.click(findTestObject('Object Repository/optima/optima-dashboard/cetak_report_CSV'))
WebUI.takeScreenshot()
WebUI.delay(3)

WebUI.click(findTestObject('Object Repository/optima/optima-dashboard/button_Export'))
WebUI.click(findTestObject('Object Repository/optima/optima-dashboard/cetak_report_Excel'))
WebUI.takeScreenshot()
WebUI.delay(3)
