...
WebUI.click(findTestObject('Object Repository/optima/menu_sub_Active Product List'))
WebUI.takeScreenshot()
WebUI.delay(3)

WebUI.selectOptionByValue(findTestObject('Object Repository/optima/select_Aggregator'),  GlobalVariable.appID_retribusi, false)
WebUI.takeScreenshot()
WebUI.delay(3)

WebUI.click(findTestObject('Object Repository/optima/button_Search_aggregator'))
WebUI.takeScreenshot()
WebUI.delay(3)
