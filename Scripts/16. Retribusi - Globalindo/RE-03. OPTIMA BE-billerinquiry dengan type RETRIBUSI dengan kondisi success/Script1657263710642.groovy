...
import java.text.SimpleDateFormat
	...
	String amount = parsedJson.get("data").get("applicationAmount")
	...
	WebUI.comment("Amount Retribusi: "+amount)
	WebUI.comment("inquiryReferenceNumber: "+inquiryReferenceNumber)
