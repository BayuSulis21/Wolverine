...
import com.kms.katalon.core.testobject.impl.HttpUrlEncodedBodyContent //for URL encoded text body
	...
	String inquiryReferenceNumber = parsedJson.get("data").get("inquiryReferenceNumber")
	GlobalVariable.inquiryReferenceNumber=inquiryReferenceNumber
	String amount_retribusi = parsedJson.get("data").get("applicationAmount")
	GlobalVariable.amount_retribusi=amount_retribusi
	WebUI.comment("Inquiry Reference Number: "+inquiryReferenceNumber)
	WebUI.comment("Amount Retribusi: "+amount_retribusi)
