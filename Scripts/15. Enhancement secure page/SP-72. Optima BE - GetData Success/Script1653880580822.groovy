...
import org.apache.commons.codec.binary.Base64;
	...
	WS.callTestCase(findTestCase('15. Enhancement secure page/SP-01. BE - Melakukan inquiry tagihan'), null)

	RequestObject GetData=findTestObject('Object Repository/Secure page/GetData')
	...
	GetData.setBodyContent(new HttpTextBodyContent(jsonbody, "UTF-8", "application/json"))
	//set httpheader
	...
	GetData.setHttpHeaderProperties(HTTPHeader)
	
	def responseObj = WS.sendRequest(GetData)
