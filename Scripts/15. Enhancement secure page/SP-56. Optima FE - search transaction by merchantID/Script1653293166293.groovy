...
WebUI.setText(findTestObject('Object Repository/secure page-optima/OPTIMA Dashboard - Secure Page Transaction/input_Merchant ID_merchantid'), 'MOAJAH000011111')
WebUI.takeScreenshot()
WebUI.delay(2)
