...
import org.apache.commons.codec.binary.Base64;
	...
	String amount_hasil=amount.toString()
	
	String jsonbody_refund = '{"phoneNumber": "'+phoneNumber+'","referenceNumber": "'+referenceNumber+'","partnerRefundId": "'+partnerRefundId+'","amount": '+amount_hasil+'}'
	WebUI.comment(jsonbody_refund)
	String jsonbody_replace_refund = '{phoneNumber:'+phoneNumber+',referenceNumber:'+referenceNumber+',partnerRefundId:'+partnerRefundId+',amount:'+amount_hasil+'}'
	...
	for (int baris = 1; baris <= 2; baris++) {
		WebUI.comment("REFUND YANG KE-"+baris+" : "+amount_hasil)
