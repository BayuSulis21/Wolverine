...
//PEMBAYARAN
	...
	//random trxID
	String trxID="BAYU1610000"+Math.abs(new Random().nextInt() % 999999)
	...
	WebUI.delay(3)
	WebUI.setText(findTestObject('Secure page/Epin1'), GlobalVariable.pin)
	WebUI.takeScreenshot()
	WebUI.delay(3)
	WebUI.click(findTestObject('Object Repository/Secure page/div_Selesai'))
	WebUI.delay(3)
	WebUI.closeBrowser()
