...
if (Mobile.verifyElementVisible(findTestObject('Qris/Enominal-static-Us Tip Enabled'), 5, FailureHandling.OPTIONAL)) {
	Mobile.comment("Input Nominal")
	Mobile.setText(findTestObject('Qris/Enominal-static-Us Tip Enabled'), GlobalVariable.qris_nominal_bayar, 0)
	Mobile.takeScreenshot()
	Mobile.delay(1)
} 

//Kondisi untuk Qris Us Tips Enabled
if (Mobile.verifyElementVisible(findTestObject('Qris/Etips-static-Us Tip Enabled'), 5, FailureHandling.OPTIONAL)) {
	Mobile.comment("Input Tips")
	Mobile.setText(findTestObject('Qris/Etips-static-Us Tip Enabled'), GlobalVariable.qris_nominal_tips, 0)
	Mobile.takeScreenshot()
	Mobile.delay(1)
}
